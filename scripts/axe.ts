...
const RULE_COPY: Record<string, [string, string, string]> = {
  "image-alt": [
  ...
  "target-size": [
    ...
    "Asegurarse de que botones y enlaces tienen al menos 24×24 px de área toca\ble (WCAG 2.5.8).",
